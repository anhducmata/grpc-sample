...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserById = channel.unary_unary(
                '/mypackage.UserService/GetUserById',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'mypackage.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def CreateUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mypackage.UserService/CreateUser',
    ...
    def GetUserById(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mypackage.UserService/GetUserById',
